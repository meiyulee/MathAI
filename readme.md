...
1. **全球唯一** - 做到數字驅動的數學建模人工智能
2. **專業人員的建模工具** - 為科學、商業、工程、醫學、農業等專業人員而生的數字型數學建模工具
3. **人工智能做到最佳化** - 自動查驗數字的數學模型，做到最佳化時需要多少條數學模型，形成數字集的模型
4. **海量數學函數** - 建模過程由AI從海量的數學函數或模型，選擇符合數字的最佳模型
5. **是數學模型，非迴歸分析** - 從迴歸分析法改良成為數字的精準數學建模。軟體的模型方法稱為多線段法
6. **運算結果可查驗** - 保存數學模型之結果、估計值結果等運算結果。可將之匯入Excel觀看圖形
7. **可人工設定希望AI判斷的準確率條件** - 選擇數字的數學模型過程需要兩個參數條件，分別為數字的估算解釋力超過多少就得重新開始新的區段估計。第二是每次線段的重新估算所需的最少資料量。後者同樣可交給AI決定，做到數據說話。
8. 運算快速** - 軟體簡單好用易操作，三個步驟設定好就跑結果(參考：https://youtu.be/HWqU1jJr174)，並且運算快速，為你節剩下更多時間。
...
| 方法1 | ~方法2~ |
| ---- | ---- |
| 1. 將【lines combined】文件夾，複製貼上到C槽 <br> 2. 打開 C:\lines combined，將捷徑拖曳到桌面 <br> 3. 點擊桌面捷徑，開始執行程式 | 1. 解壓縮從One drive下載的壓縮檔 <br> 2. 將【lines combined】文件夾，複製貼上到C槽 <br> 3. 打開 C:\lines combined，將捷徑拖曳到桌面 <br> 4. 點擊桌面捷徑，開始執行程式 |
